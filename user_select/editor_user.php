            ...
            <div class="row">
                <div class="col-md-4">
                    <ul id="myTabs" class="nav nav-tabs nav-stacked" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#Pending" data-toggle="tab" role="tab" aria-controls="statues">Pending Article list</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-8">
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="Pending">
                            <ul id="articleNames">
                              <?php
                              $sql= "SELECT ID FROM `Article` WHERE `Editor_UID` = ".$theID." AND Status = 'Processing'";
                              //$resNum=getResultNum($sql);
                              $rows=fetchAll($sql);

                              foreach($rows as $row1):

                              $sql= "Select Title from Article where ID =".$row1['ID']."";
                              $row2=fetchOne($sql);
                              ?>
                                <li><a id="article_1" href="Write_Comment.php?ID=<?php echo $row1['ID']?>"><?php echo $row2['Title']?></a></li>
